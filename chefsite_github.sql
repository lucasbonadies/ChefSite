...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2025 a las 16:04:21
...
INSERT INTO `articulos` (`id_articulo`, `nombre`, `precio_unitario`, `descripcion`, `imagen`, `id_tipo`, `id_estado`) VALUES
(1, 'Pollos al horno con guarnición', 7000.00, '', 'pollo-al-horno-1.png', 1, 11),
(2, 'Milanesa con papas fritas', 5500.00, '', 'milanesa-2.webp', 1, 11),
(3, 'Sprite 500ml', 2500.00, 'Botella de vidrio', 'sprite.jpg', 2, 11),
(4, 'Helado en bochas', 8960.60, '4 bochas de diferentes sabores', 'helado-2.jpg', 3, 11),
(5, 'Flan', 10000.10, '', 'flan-2.webp', 3, 11),
(6, 'Fanta 500ml', 2500.00, 'Botella de vidrio', 'fanta.jpg', 2, 11),
(7, 'Coca-cola 500ml', 2500.00, 'Botella de vidrio', 'coca-cola.jpg', 2, 11),
(8, 'Medallón de lentejas c/ ensalada', 6350.00, '', 'medallon-lenteja-1.jpg', 1, 11),
(9, 'Filet de merluza a la Romana', 8999.99, 'Echo con la más fresca merluza', 'filet-de-merluza.jpg', 1, 11),
(12, 'Agua sin gas 500ml', 2500.00, 'Botella de plástico', 'agua-500.jpg', 2, 11),
(13, 'Filete de carne c/ papas', 10000.50, 'Carne a la parrilla con ajo asado y papas rústicas horizontal', 'filete-de-carne-a-la-parrilla.webp', 1, 11),
(14, 'Taco con carne picada', 9550.00, '', 'tacos-1.jpg', 1, 11),
(15, 'Papas rústicas con salsa', 4590.80, 'Varias salsas a elección', 'Papas-Rusticas.webp', 1, 11),
(16, 'Cunnington pomelo 500ml', 2500.00, 'Botella de plástico', 'cunnington-pomelo-500ml.jpg', 2, 11),
(17, 'Schweppes 500ml', 2500.00, 'Botella de plástico', 'schweppes-500ml.jpeg', 2, 11),
(18, 'Panna cotta', 9980.00, '', 'Panna cotta.jpg', 3, 11),
(19, 'Tiramisú', 9580.20, '', 'Tiramisú.jpg', 3, 11),
(20, 'Profiteroles', 5000.50, '', 'Profiteroles.jpg', 3, 11),
(21, 'Coulant de chocolate', 8500.00, '', 'coulant de chocolate.jpg', 3, 11),
(22, 'Ensalada de Frutas', 6575.85, 'Varias frutas frescas', 'ensalada-frutas.jpg', 3, 11),
(37, 'Sushi', 1500.00, 'fresco', 'sushi.jpg', 1, 11),
(39, 'Rabas', 5000.00, 'Frescas', 'rabas-caseras.webp', 3, 12);
...
(2, 'inactivo', 'usuario', 'no puede usar el sistema'),
(3, 'pendiente', 'reserva', 'ha sido creada pero aun no ha sido confirmada'),
(4, 'confirmada', 'reserva', 'ha sido confirmada'),
(5, 'cancelada', 'reserva', 'ha sido cancelada'),
(6, 'pendiente', 'pedido', 'pendiente'),
(7, 'preparado', 'pedidos', 'listo para ser entregado'),
(8, 'entregado', 'pedido', 'el cliente recibio su pedido'),
(9, 'cancelado', 'pedido', 'su pedido fue cancelado'),
(10, 'en proceso', 'pedidos', 'fue recibido en la cocina y se esta preparando'),
(11, 'activo', 'articulo', 'se muestra en el menu'),
(12, 'inactivo', 'articulo', 'no se muestra en el menu'),
(13, 'aceptado', 'pagos', 'El pago fue aceptado'),
(14, 'rechazado', 'pagos', 'El pago fue rechazado');
...
INSERT INTO `mesas` (`id_mesa`, `numero_de_mesa`, `descripcion`) VALUES
(1, 1, NULL),
(2, 2, NULL),
(3, 3, NULL),
(4, 4, NULL),
...
CREATE TABLE `reservas` (
  ...
  `fecha_registro_reserva` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `reservas` (`id_reserva`, `fecha_hora_reserva`, `fecha_registro_reserva`, `cantidad_personas`, `id_estado`, `id_mesa`) VALUES
(1, '2024-05-29 22:30:00', '2024-05-30 01:11:16', 1, 3, 1),
(5, '2024-01-23 11:00:00', '2024-05-30 01:19:57', 1, 3, 1),
(6, '2024-06-02 23:03:00', '2024-06-02 19:09:43', 1, 3, 1),
(7, '2024-06-02 23:00:00', '2024-06-02 19:13:22', 1, 3, 1),
(8, '2024-06-02 23:00:00', '2024-06-02 19:16:44', 1, 3, 1),
(9, '2024-06-02 23:01:00', '2024-06-02 19:17:33', 1, 3, 1),
(10, '2024-06-05 11:02:00', '2024-06-05 01:34:58', 8, 3, 1),
(11, '2024-11-10 21:00:00', '2024-11-10 22:52:10', 1, 3, 1),
(12, '2024-11-10 21:00:00', '2024-11-10 22:53:13', 1, 3, 1),
(13, '2024-11-10 21:00:00', '2024-11-10 22:54:40', 1, 3, 1),
(14, '2024-11-10 21:00:00', '2024-11-10 22:54:57', 1, 3, 1),
(15, '2024-12-24 23:00:00', '2024-12-03 00:54:37', 10, 3, 1),
(16, '2024-12-03 08:00:00', '2024-12-03 01:07:06', 5, 3, 1);
...
CREATE TABLE `tokens` (
  ...
  `token_generado` varchar(32) NOT NULL,
...
INSERT INTO `tokens` (`id_token`, `token_generado`, `expiracion`, `id_usuario`) VALUES
(1, 'ddeecbc397775ccd4a68ecf54655ac92', '2024-09-12 02:07:05', 8),
(2, '39844d42613f88b7fb338bb9e9fccb27', '2024-09-12 02:11:34', 8),
(4, '12e3a36f5e030158526ac0e3097f1cd4', '2024-09-13 01:09:51', 8),
(6, '37ff657e2fe2bd50422bddbf2eef4b6b', '2024-09-13 02:17:31', 8),
(7, '609880e7913a0102c8b6361640ad1c93', '2024-09-13 02:18:11', 8),
(8, '31b89032cda753bd7ebd58fd416f3c8d', '2024-09-13 02:21:37', 8),
(9, '213a834e9bcff5840d3c96a801aea645', '2024-09-12 21:24:41', 8),
(10, 'd58d1020c402ef028b819f141c78b6bd', '2024-09-12 23:06:01', 8),
(12, '991463b52231cff2288c8cf5ff162272', '2024-09-13 19:35:38', 7),
(13, '3b44f28cacb517d571a5085e7b16e3fc', '2024-09-14 20:40:37', 8),
(21, '5b79091bf8f5ed78ca1b8ceb095ee30e', '2024-10-26 14:25:40', 8),
(22, 'a1bc5f243d57454f16000fc905df2ff9', '2024-11-05 20:16:18', 8),
(27, '2524267d55f739767e22f51af94eaed2', '2024-11-13 22:53:32', 19),
(28, '538bf48eec4c642acf41c795bcabcec7', '2024-11-13 23:02:27', 19),
(29, '37e4dd36a096d8cfed7e697c6b3364f2', '2024-11-13 23:10:21', 19),
(30, 'ea0cd33a3485d532575bd0c5910b6135', '2024-11-13 23:10:22', 19),
(31, 'd8622290b6d0ae54198491b24945cbeb', '2024-11-13 23:10:40', 19),
(32, '2413551e4ea3a8c27b414c16e9f1b2db', '2024-11-13 23:14:32', 19),
(33, 'a3c82847a47eef81361b56a814c059fb', '2024-11-13 23:24:37', 19),
(34, 'f37737c99bc319515e634f6a5929af32', '2024-11-13 23:38:09', 19),
(37, '8114a2184aa2c845119ee008cc222697', '2024-12-09 23:08:12', 10),
(38, 'b0e22ece1abe7468e1bc0ca912e95356', '2024-12-12 00:15:22', 21),
(39, '93ada377f8edc036c6eaf6caa04bdde1', '2024-12-12 19:52:02', 18);
...
ALTER TABLE `articulos`
  ...
  ADD KEY `fk_articulos_tipo_articulos` (`id_tipo`),
  ADD KEY `fk_articulos_estados` (`id_estado`);
...
ALTER TABLE `detalle_pedidos`
  ...
  ADD KEY `fk_detalle_pedidos_pedidos` (`id_pedido`),
  ADD KEY `fk_detalle_pedidos_articulos` (`id_articulo`);
...
ALTER TABLE `empleados`
  ...
  ADD KEY `fk_empleados_ocupaciones` (`id_ocupacion`),
...
ALTER TABLE `pedidos`
  ...
  ADD KEY `fk_pedidos_personas` (`id_persona`);
...
ALTER TABLE `personas`
  ...
  ADD KEY `fk_pais_persona` (`id_pais`),
  ADD KEY `fk_personas_provincias` (`id_provincia`),
  ADD KEY `fk_personas_localidades` (`id_localidad`);
...
ALTER TABLE `provincias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_provincias_paises` (`id_pais`);
...
ALTER TABLE `reservas`
  ...
  ADD KEY `fk_reservas_mesas` (`id_mesa`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_niveles` (`id_nivel`);
...
--
ALTER TABLE `articulos`
  ADD CONSTRAINT `fk_articulos_estados` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_articulos_tipo_articulos` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_articulos` (`id_tipo`);

--
-- Filtros para la tabla `detalle_pedidos`
--
ALTER TABLE `detalle_pedidos`
  ADD CONSTRAINT `fk_detalle_pedidos_articulos` FOREIGN KEY (`id_articulo`) REFERENCES `articulos` (`id_articulo`),
...
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `fk_empleados_ocupaciones` FOREIGN KEY (`id_ocupacion`) REFERENCES `ocupaciones` (`id_ocupacion`),
...
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`);

--
-- Filtros para la tabla `pedidos`
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `fk_pedidos_estados` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_pedidos_personas` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id_persona`);

--
-- Filtros para la tabla `personas`
--
ALTER TABLE `personas`
  ADD CONSTRAINT `fk_pais_persona` FOREIGN KEY (`id_pais`) REFERENCES `paises` (`id_pais`),
  ADD CONSTRAINT `fk_personas_localidades` FOREIGN KEY (`id_localidad`) REFERENCES `localidades` (`id_localidad`),
  ADD CONSTRAINT `fk_personas_provincias` FOREIGN KEY (`id_provincia`) REFERENCES `provincias` (`id`);

--
-- Filtros para la tabla `provincias`
--
ALTER TABLE `provincias`
  ADD CONSTRAINT `fk_provincias_paises` FOREIGN KEY (`id_pais`) REFERENCES `paises` (`id_pais`);

--
-- Filtros para la tabla `reservas`
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_reservas_estados` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_reservas_mesas` FOREIGN KEY (`id_mesa`) REFERENCES `mesas` (`id_mesa`);

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_persona_usuario` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id_persona`),
  ADD CONSTRAINT `fk_usuarios_estados` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_usuarios_niveles` FOREIGN KEY (`id_nivel`) REFERENCES `niveles` (`id_nivel`);
COMMIT;
